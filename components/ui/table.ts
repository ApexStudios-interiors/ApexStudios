...
export const trClick = "cursor-pointer hover:bg-muted/60";
export const trTotal = "font-bold bg-muted/50";
export const sub = "block text-xs text-muted-foreground font-normal mt-0.5";
